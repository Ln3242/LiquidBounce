...
MovementSection:NewToggle("AutoToxic", "lol", function(state)--springs
    if state then
			repeat task.wait() until game:IsLoaded()
loadstring(game:HttpGet("https://raw.githubusercontent.com/LN3242/ChatBxpass/main/AntiBan.lua"))()
local words = {
    ["hitler"] = "Нiт1ея",
    ["nigga"] = "И1ggа",
    ["nigger"] = "И1 gg ег",
...
chat("Imagine not using script LiquidBounce")
wait(2.5)
chat("Imagine dying to script LiquidBounce L")
wait(2.5)
chat("I like minors boobs")
wait(2.5)
chat("niggers")
wait(2.5)
 end
